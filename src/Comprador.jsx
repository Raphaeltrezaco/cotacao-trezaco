              ...
              <div key={i} style={{ background:'#fff', borderRadius:8, padding:'12px 14px', marginBottom:8, border:`1px solid ${s2.confianca === 'alta' ? '#1D9E75' : s2.confianca === 'media' ? '#EF9F27' : '#E0DED8'}` }}>
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start' }}>
                  <div style={{ flex:1 }}>
                    ...
                    <div style={{ fontSize:12, color:'#888780' }}>\u1f4e6 Estoque: <strong style={{ color: s2.quantidade_disponivel >= selecionado.quantidade ? '#085041' : '#A32D2D' }}>{s2.quantidade_disponivel?.toLocaleString('pt-BR')} kg</strong>
        ...
        {historico.length > 0 && (
          <div style={{ ...s.card, background:'#FFFBF0', border:'1px solid #FAE8A0' }}>
            <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:14 }}>
              <span style={{ fontSize:16 }}>\u1f4a1</span>
